...
✨ **Настроен автоматический деплой на сервер при push в ветку `deploy`!**

- 📖 Быстрый старт: [DEPLOY_QUICKSTART.md](DEPLOY_QUICKSTART.md)
- 📚 Полная инструкция: [DEPLOY_SETUP.md](DEPLOY_SETUP.md)
- 🔐 **База данных защищена** - данные сохраняются при обновлениях
